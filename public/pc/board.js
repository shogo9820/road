// =========================================================================
// board.js : Excelマップレイアウト完全再現版（消去バグ完全対策型）
// =========================================================================

window.boardManager = {
  canvas: null,
  ctx: null,
  gridSize: 38, // マスの描画サイズ
  cols: 26,
  ...
  // 🎯 修正：[ ] を廃止し、絶対に消去されない {x, y} 形式でExcelの位置（列, 行）を完全記述
  gridMap: {
    0: { x: 23, y: 18 },  1: { x: 21, y: 18 },  2: { x: 21, y: 16 },  3: { x: 23, y: 16 },
    4: { x: 23, y: 14 },  5: { x: 23, y: 12 },  6: { x: 23, y: 10 },  7: { x: 23, y: 8 },
    8: { x: 19, y: 18 },  9: { x: 17, y: 19 }, 10: { x: 17, y: 17 }, 11: { x: 17, y: 15 },
    12: { x: 17, y: 13 }, 13: { x: 17, y: 11 }, 14: { x: 17, y: 9 },  15: { x: 17, y: 7 },
    16: { x: 19, y: 6 },  17: { x: 21, y: 6 },  18: { x: 21, y: 4 },  19: { x: 21, y: 2 },
    20: { x: 21, y: 0 },  21: { x: 19, y: 0 },  22: { x: 17, y: 0 },  23: { x: 17, y: 2 },
    24: { x: 15, y: 2 },  25: { x: 15, y: 0 },  26: { x: 13, y: 0 },  27: { x: 13, y: 2 },
    28: { x: 13, y: 4 },  29: { x: 13, y: 6 },  30: { x: 13, y: 8 },  31: { x: 13, y: 10 },
    32: { x: 13, y: 12 }, 33: { x: 13, y: 14 }, 34: { x: 13, y: 16 }, 35: { x: 13, y: 18 },
    36: { x: 11, y: 18 }, 37: { x: 9, y: 18 },  38: { x: 7, y: 18 },  39: { x: 5, y: 18 },
    40: { x: 3, y: 18 },  41: { x: 1, y: 18 },  42: { x: 1, y: 16 },  43: { x: 1, y: 14 },
    44: { x: 1, y: 12 },  45: { x: 1, y: 10 },  46: { x: 1, y: 8 },   47: { x: 1, y: 6 },
    48: { x: 1, y: 4 },   49: { x: 1, y: 2 },   50: { x: 3, y: 2 },   51: { x: 5, y: 2 },
    52: { x: 5, y: 4 },   53: { x: 5, y: 6 },   54: { x: 5, y: 8 },   55: { x: 5, y: 10 },
    56: { x: 3, y: 10 },  57: { x: 3, y: 12 },  58: { x: 3, y: 14 },  59: { x: 7, y: 2 },
    60: { x: 9, y: 2 },   61: { x: 11, y: 2 },  62: { x: 11, y: 4 },  63: { x: 9, y: 4 },
    64: { x: 7, y: 4 },   65: { x: 7, y: 6 },   66: { x: 9, y: 6 },   67: { x: 9, y: 8 },
    68: { x: 9, y: 10 },  69: { x: 9, y: 12 },  70: { x: 9, y: 14 },  71: { x: 7, y: 14 },
    72: { x: 7, y: 12 },  73: { x: 7, y: 10 },  74: { x: 7, y: 8 },   75: { x: 5, y: 14 },
    76: { x: 5, y: 12 },  77: { x: 5, y: 16 },  78: { x: 7, y: 16 },  79: { x: 9, y: 16 },
    80: { x: 11, y: 16 }, 81: { x: 11, y: 14 }, 82: { x: 11, y: 12 }, 83: { x: 11, y: 10 },
    84: { x: 11, y: 8 },  85: { x: 11, y: 6 },  86: { x: 15, y: 12 }, 87: { x: 15, y: 14 },
    88: { x: 15, y: 16 }, 89: { x: 15, y: 18 }, 90: { x: 17, y: 18 }, 91: { x: 19, y: 18 },
    92: { x: 19, y: 16 }, 93: { x: 19, y: 14 }, 94: { x: 17, y: 14 }, 95: { x: 15, y: 14 },
    96: { x: 15, y: 10 }, 97: { x: 15, y: 8 },  98: { x: 15, y: 6 },   99: { x: 15, y: 4 }
  },
  ...
  init(gridSize) {
    ...
    this.canvas.width = 26 * this.gridSize;
    this.canvas.height = 20 * this.gridSize;
  },

  // 🎯 修正：オブジェクト形式から正確に x と y のマス位置を取り出す
